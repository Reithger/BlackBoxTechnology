...
public class Title extends Screen{
	...
	public Title(int x, int y, int inWidth, int inHeight, Core parent, String inName) {
	...
	public void initialize() {
		...
		center.addButton("butt", 0, getWidth() / 2, getHeight() * 2 / 3, getWidth() / 5, getHeight() / 6, new Color(84, 34, 200), Core.TITLE_NAVIGATE_NEXUS, ElementPanel.CENTERED);
